...
from evaluate.data.mbpp import mbpp_serialize_inputs
from evaluate.gen.chatgpt_gen import ChatGPTGen
...
def main():
    ...
    problems = None
    if args.dataset == "humaneval":
        from evaluate.data import get_human_eval_plus
    ...
    if args.dataset == "mbpp":
        from evaluate.data import get_mbpp_plus
